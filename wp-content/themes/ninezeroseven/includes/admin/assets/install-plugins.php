...
function wbc907_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'source'       => 'http://themesazan.ir/907/wbc907-core-3.2.3.zip', // The plugin source
		...
		array(
			...
			'version'      => '6.5.14', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
			'external_url' => '', // If set, overrides default API URL and points to an external URL
